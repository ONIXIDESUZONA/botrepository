...
TokenFile = open("D:/Documents/Desktop/serverr/music1/Token.txt","r")
TOKEN = TokenFile.read()

OWNERID = 738509199545335829
...
async def on_command_error(ctx, error):
    ...
    if isinstance(error, commands.MissingPermissions):
        embed.add_field(name=f'Invalid Permissions',
...
for filename in os.listdir("D:/Documents/Desktop/serverr/music1/Cogs"):
    if filename.endswith("music.py"):
        try:
...
# Run our bot
# Make sure you paste the CORRECT token in the ".C:\Users\zheny\Desktop\MusicBotinDiscordpy-main\data\Token.txt" file
bot.run(str(TOKEN))
